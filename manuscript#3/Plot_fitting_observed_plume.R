...
create_plot <- function(data1, data2){
  ...
  ggplot()+
    ...
    labs(y = bquote(''*N[2]*O*' Enhancements [ppb]'), x = "Distance [km]")+
    theme_bw()+
...
ggsave("D:/1 PhD Studies/3.5 Publications/Manuscript#3_Rotterdam_emission_estimates/Figures/SI/n2o.observed.plume.tiff", plot = p,
       width = 300, height = 75, units = "mm", dpi = 300, compression = "lzw")
